...
import com.soflyit.common.core.annotation.Excels;
...
public class SysUser extends BaseEntity {
    ...
    @Excel(name = "部门编号(必填)", type = Type.EXPORT)
    private Long deptId;
    ...
    @Excel(name = "用户名称(必填)", prompt = "登录名，必填")
    ...
    @Excel(name = "用户性别", prompt = "(男，女，未知)", readConverterExp = "0=男,1=女,2=未知")
    private String sex;
    ...
    @Getter
    @Setter
    @Excel(name = "部门编码(必填)", prompt = "对应菜单“部门管理”的“部门编码”列的值")
    ...
    @Getter
    @Setter
    private List<SysPost> postsList;
