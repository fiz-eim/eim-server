 ...
 */
public class MessageCancelTopEvent extends BaseImEvent<MsgTopVo, ChatBroadcast<Long, Long, ChannelId>> {

    public MessageCancelTopEvent() {
        setEvent(ChatEventName.MESSAGE_CANCEL_TOP);
    }
}
