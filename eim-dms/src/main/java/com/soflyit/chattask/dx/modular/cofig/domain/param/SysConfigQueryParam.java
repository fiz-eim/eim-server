...
@ApiModel
@Data
public class SysConfigQueryParam implements Serializable {
    private static final long serialVersionUID = 1L;


    @ApiModelProperty("配置项")
    private OrderByParam<String> configKey;


    @ApiModelProperty("配置信息状态;1.正常；-1.未启用等")
    private OrderByParam<Long> configStatus;


    @ApiModelProperty("配置值")
    private OrderByParam<String> configValue;
}
